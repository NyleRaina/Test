...
//                String url1 = "https://jsonplaceholder.typicode.com/posts/1";
        ...
        GraphButtonNut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PieEntry pieEntry=new PieEntry(percentCarb2,"Carbs: " + percentCarb2+"%");
                PieEntry pieEntry1=new PieEntry(percentFat2,"Fat: " + percentFat2+"%");
                PieEntry pieEntry2=new PieEntry(percentFib2,"Fiber: "+ percentFib2+"%");
                PieEntry pieEntry3=new PieEntry(percentPro2,"Protein "+percentPro2+"%");
